...
var string = {
  ...
  boolean_is = function(u) {
    return "boolean" == typeof u;
  },
  object = {
    is: function(u) {
      return null != u && !string.is(u) && !number.is(u) && !boolean_is(u);
    }
  };
function compose(M) {
  return function(ab) {
...
var traverseRecordWithIndex = function(M) {
  ...
  Person = pipe$1(
    fromGuard(object, "object"),
    compose$1(type$1({ name: string$1, age: number$1 }))
  );
